            ...
            <div class="shopDetail-row">
                <div class="shopDetail-col">
                    ...
                    <div class="update-name">
                        <div class="row-value">{{formatType(printer.printerType)}}</div>
                    </div>
                </div>
                <div class="shopDetail-col">
                    <div class="row-title">设备名称</div>
                    <div class="update-name">
                        <div class="row-value">{{printer.deviceName}}</div>
                    </div>
                </div>
                <div class="shopDetail-col">
                ...
                <div class="shopDetail-col">
                    ...
                    <div class="update-name">
                        <div class="row-value">{{printer.printerPageType}}</div>
                    </div>
                </div>
                <div class="shopDetail-col">
...
<script>
    import { getPrinterById,updatePrinter } from '@/api/api'
    export default {
        name: 'updatePrinter',
        data: function() {
            var that = this;
        ...
        created: function() {
            ...
            var id = this.$route.query.printerId;
            this.printerId = id;
            this.$indicator.open();
            getPrinterById(this.printerId).then(res => {
                console.log(res);
                this.printer = res;
        ...
        methods: {
            ...
            save: function() {
                updatePrinter(this.printerId, this.printer).then(res => {
                    console.log(res);
                    this.$indicator.close();
                    this.$toast({
                        message: '编辑成功',
