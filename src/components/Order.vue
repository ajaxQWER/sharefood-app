                                ...
                                <router-link :to="'/orderDetail?orderId='+item.orderId" class="link">
                                    <div class="order-row">
                                        <div class="order-number-row">
                                            <div class="order-number order-number-sub">#{{item.orderNum.toString().substr(-4)}}</div>
                                            <div class="order-cancelType" v-if="item.orderCancel.cancelType">{{formatCancelType(item.orderCancel.cancelType)}}</div>
                                        </div>
                                        <div class="order-number-row">
                                    ...
                                    <div class="order-row">
                                        <div class="order-detail">
                                            ...
                                            <div class="order-item">订单备注<span>{{item.orderContent?item.orderContent:'无'}}</span></div>
                                        </div>
                                    </div>
